...
export default function LoquivoApp({
  storageKey,
          ...
          {step === 0 ? (
            ...
            >
              ...
              <label className="analytics-consent">
                ...
                />
                <span>
                  <strong>Help improve Loquivo</strong>
                  <small>
        ...
        <div className="today-main">
          <section className="hero-card" aria-labelledby="today-session-title">
            ...
            <div className="hero-card-art" aria-hidden="true">
              ...
              <div className="hero-postmark">LOQUIVO · {String(currentRegion.number).padStart(2, "0")}</div>
            </div>
          </section>
...
function ProfileScreen({
  ...
  function exportProgress() {
    ...
    anchor.href = url;
    anchor.download = `loquivo-progress-${localDateKey()}.json`;
    anchor.click();
