...
export const metadata = {
  title: "Accessibility — Paretto",
  description: "Paretto accessibility features, target, and feedback process.",
};
...
export default function AccessibilityPage() {
  return (
    <LegalDocument
      ...
      intro="Paretto is designed toward WCAG 2.2 Level AA. This is a commitment and testing target, not an unsupported certification claim."
    >
