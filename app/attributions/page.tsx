...
export const metadata = {
  title: "Attributions — Pas à Pas",
  description: "Open-source, font, icon, and French audio attributions for Pas à Pas.",
};
...
export default function AttributionsPage() {
  return (
    <LegalDocument
      ...
      title="The tools and open materials that helped Pas à Pas speak clearly."
      intro="Pas à Pas keeps required notices discoverable here and ships machine-readable audio provenance with every release."
    >
      ...
      <LegalSection title="Original product material">
        <p>
          The Pas à Pas interface, original curriculum arrangement, regional
