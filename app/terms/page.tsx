...
export const metadata = {
  title: "Terms of use — Pas à Pas",
  description: "The terms governing use of the Pas à Pas learning service.",
};
...
export default function TermsPage() {
  return (
    <LegalDocument
      ...
      intro="By accessing Pas à Pas, you agree to these Terms. If you do not agree, do not use the service."
    >
      <LegalSection title="The service">
        <p>
          Pas à Pas provides French vocabulary lessons, pronunciation,
      ...
      <LegalSection title="Content and intellectual property">
        <p>
          Pas à Pas and its original interface, curriculum arrangement,
