                    ...
                    Button { selectedWord = word } label: {
                        HStack(spacing: 14) {
                            ...
                            VStack(alignment: .leading, spacing: 3) {
                                Text(word.french).font(.headline).pasAccessibilityLanguage("fr-FR")
        ...
        NavigationStack {
            ScrollView {
                VStack(spacing: 18) {
                    ...
                    Text(word.french).font(.largeTitle.bold()).pasAccessibilityLanguage("fr-FR")
                    ...
                    BrandCard {
                        VStack(spacing: 10) {
                            Text(word.exampleFr).font(.headline).pasAccessibilityLanguage("fr-FR")
