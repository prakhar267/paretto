    ...
    var body: some View {
        Form {
            ...
            Section("About") {
                ...
                Text("Pas à Pas is designed toward WCAG 2.2 AA and contains no advertising or tracking SDKs.")
                    .font(.footnote)
                    .foregroundStyle(.secondary)
            }
        ...
        .confirmationDialog(
            ...
            Text(model.authSession == nil
                ...
                : "This removes learning progress from this device and from the Pas à Pas service. This cannot be undone.")
        }
        .confirmationDialog(
        ...
        .fileExporter(
            ...
            contentType: .json,
            defaultFilename: "pas-a-pas-progress"
        ) { result in
