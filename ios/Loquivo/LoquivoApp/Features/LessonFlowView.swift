        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                Text(word.french)
                    ...
                    .loquivoAccessibilityLanguage("fr-FR")
                ...
                if revealed {
                        ...
                        VStack(spacing: 14) {
                            ...
                            if let gender = word.gender {
                                Text(gender.capitalized)
                                    ...
                                    .padding(.vertical, 5)
                                    .background(Color.loquivoGold.opacity(0.18), in: Capsule())
                            }
                            Divider()
                            Text(word.exampleFr)
                                .font(.headline)
                    ...
                    (dynamicTypeSize.isAccessibilitySize
                        ...
                        RatingButton(title: "Again", subtitle: "10 min", color: .loquivoCoral, foregroundColor: .white) {
                            advance(word, rating: .again)
                        }
                        RatingButton(title: "Almost", subtitle: "Later today", color: .loquivoGold, foregroundColor: .loquivoNavy) {
                            advance(word, rating: .hard)
                        }
                        RatingButton(title: "Got it", subtitle: "Build interval", color: .loquivoBlue, foregroundColor: .white) {
