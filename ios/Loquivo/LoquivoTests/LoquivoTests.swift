...
struct LoquivoTests {
    ...
    @MainActor
    @Test("Legacy privacy suppression flags migrate across the rebrand")
    func legacySuppressionFlagsMigrate() {
        let defaults = isolatedDefaults()
        defaults.set(true, forKey: "pas-a-pas.ignore-persisted-progress")
        defaults.set(true, forKey: "pas-a-pas.ignore-keychain-session")

        _ = AppModel(
            environment: .debug,
            repositoryURL: FileManager.default.temporaryDirectory
                .appendingPathComponent("loquivo-migration-\(UUID().uuidString).json"),
            loadsKeychain: false,
    ...
    func generatedProjectUsesSharedConfiguration() throws {
        ...
        let project = projectRoot
            .appendingPathComponent("Loquivo.xcodeproj/project.pbxproj")
    ...
    private func makeModel() -> AppModel {
        AppModel(
            environment: .debug,
            repositoryURL: FileManager.default.temporaryDirectory
                .appendingPathComponent("loquivo-test-\(UUID().uuidString).json"),
            loadsKeychain: false,
    ...
    private func isolatedDefaults() -> UserDefaults {
        let suite = "com.loquivo.tests.\(UUID().uuidString)"
